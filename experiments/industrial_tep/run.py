#!/usr/bin/env python3
"""
Reproduce the Tennessee Eastman Process (TEP) industrial fault detection experiment.

This script runs the full TEP experiment pipeline:
...
def main():
    parser = argparse.ArgumentParser(
        description="Reproduce TEP industrial fault detection experiment",
